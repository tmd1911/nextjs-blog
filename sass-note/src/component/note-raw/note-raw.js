...
class NoteRaw extends Component {
    ...
    render = () => {
        ...
        <div id="note-form">
            <input id="note-title" name="title" type="text" placeholder="메모 제목 입력" value={this.state.title} onChange={this.changeTitle} className="radius"/>
            <textarea id="note-text" name="text" placeholder="텍스트 입력" value={this.state.text} onChange={this.changeText} className="radius"/>
        </div>
